...
@php
$unreadCount = app('App\Http\Controllers\Website\NoticeController')->unreadCount();
@endphp
            ...
            <ul>
                ...
                <li class="@if($currentRouteName == 'website.notices') active @endif">
                    <a href="{{ route('website.notices',['site_name'=>$site_name]) }}">
                        ...
                        {{__('account.notice')}}
                        @if($unreadCount > 0)
                        <span class="dashboard__label">{{ $unreadCount }}</span>
                        @endif
                    </a>
                </li>
                ...
                <li class="@if($currentRouteName == 'website.orders.history') active @endif">
                    <a href="{{ route('website.orders.history',['site_name'=>$site_name]) }}">
                    <i class="icofont-history"></i>
                        {{__('account.history')}}</a>
                </li>
