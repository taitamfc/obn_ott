                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.html"><img loading="lazy"
                                        src="{{ asset('website/img/grid/grid_7.png')}}" alt="grid"></a>
                                ...
                                <div class="gridarea__bottom">
                                    ...
                                    <a href="instructor-details.html">
                                        <div class="gridarea__small__img">
                                            <img loading="lazy" src="{{ asset('website/img/grid/grid_small_1.jpg')}}"
                                                alt="grid">
                    ...
                    <div
                        ...
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.html"><img loading="lazy"
                                        src="{{ asset('website/img/grid/grid_8.png')}}" alt="grid"></a>
                    ...
                    <div
                        ...
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.html"><img loading="lazy"
                                        src="{{ asset('website/img/grid/grid_9.png')}}" alt="grid"></a>
                                <div class="gridarea__small__button">
                                    <div class="grid__badge">Data & Tech</div>
                                </div>
                                <div class="gridarea__small__icon">
