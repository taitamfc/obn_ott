                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="checkoutarea__inputbox">
                                        <label for="first__name">Full Name
                                            *</label>
                                        <input type="text" id="first__name"
                                            name="nameuser" class="info"
                                            placeholder="Full Name">
                                            @if($errors->has('nameuser'))
                                                <div style="color:red;font-size: 12px;" class="error-message pd-0">{{ $errors->first('nameuser') }}</div>
                                            @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="checkoutarea__inputbox">
                                        <label for="email__address">Email
                                            Address*</label>
                                        <input type="text" id="email__address"
                                            name="email" class="info"
                                            placeholder="Your email">
                                        @if($errors->has('email'))
                                            <div style="color:red;font-size: 12px;" class="error-message pd-0">{{ $errors->first('email') }}</div>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="checkoutarea__inputbox">
                                        <label for="phone__number">Phone
                                            Number*</label>
                                        <input type="text" id="phone__number"
                                            name="phone" class="info"
                                            placeholder="Phone Number">
                                        @if($errors->has('phone'))
                                            <div style="color:red;font-size: 12px;" class="error-message pd-0">{{ $errors->first('phone') }}</div>
                                        @endif
                            ...
                            <div class="checkoutarea__payment__toggle">
                                <div class="checkoutarea__payment__total">
                                    <div class="checkoutarea__payment__type">
                                        <input type="radio" value="paypal" id="pay-toggle04"
                                            name="pay" checked>
                                        <label for="pay-toggle04">Paypal</label>
                                    </div>
                                </div>
                                <div class="checkoutarea__payment__input__box">
                                    <button class="default__button" type="submit">Place
                                        order</button>
                                </div>
                            </div>
                        </div>
