                ...
                <div class="row headerarea__search__wrap align-items-center">
                    <div class="col-xl-3 col-lg-3">
                        ...
                        <div class="headerarea__2__info__img">
                            <a href="#"><img loading="lazy" src="img/icon/flag1.webp" alt="img">
                                ENG
                            ...
                            <ul class="language__dropdown">
                                <li><a href="#"><img loading="lazy" src="img/icon/flag2.webp" class="img-fluid" alt="">
                                        FR</a></li>
                                <li><a href="#"><img loading="lazy" src="img/icon/flag3.webp" class="img-fluid" alt="">
                                        DE</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="headerarea__2__info__img">
                            ...
                            <ul class="language__dropdown">
                                <li><a href="#"><img loading="lazy" src="img/logo/logo__4.webp" class="img-fluid" alt="">
                                        FR</a></li>
                                <li><a href="#"><img loading="lazy" src="img/logo/logo__5.webp" class="img-fluid" alt="">
                                        DE</a></li>
                            </ul>
                        </div>
                                        ...
                                        <div class="headerarea__submenu mega__menu__wrapper mega__menu__grid__5">
                                            ...
                                            <ul class="nav  tab__button__wrap" id="myTab2" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <button class="single__tab__link active" data-bs-toggle="tab" data-bs-target="#projects__light" type="button" aria-selected="true" role="tab">Light</button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <button class="single__tab__link" data-bs-toggle="tab" data-bs-target="#projects__dark" type="button" aria-selected="false" tabindex="-1" role="tab">Dark</button>
                                                </li>                        
                                            </ul>
