            ...
            <div class="col-12">
                <div class="card lesson-table-results">
                    <div class="text-center pt-5 pb-5">
                        <div class="text_big">
                            <p><strong><h1>The all-in-one <span>membership</span> platform for creators</h1></strong></p>
                        </div>
                        <div class="text_small">
                            <p>Delight your die-hard fans with exclusive video content and a vibrant community across your
                                own mobile app and website </p>
                        </div>
