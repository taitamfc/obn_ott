<div class="row">
    ...
    <div class="col-lg-12">
        <div class="form-group input-name">
            ...
            <input type="text" class="form-control" name="name" id="name" value="{{ old('name') ? old('name') : $item->name  }}">
            ...
            <div class="form-floating">
                <select name="subject_id" id="subject_id" class="form-control">
                    ...
                    @foreach($subjects as $subject)
                        <option @selected( $item->subject_id == $subject->id ) value='{{ $subject->id }}'>{{ $subject->name }} </option>
                    @endforeach
                </select>
