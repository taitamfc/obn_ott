        ...
        <div class="login-form-body">
            ...
            <div class="row mb-4 rmber-area">
                ...
                <div class="col-6 text-right">
                    <a href="#" class="text-primary" data-action="#">{{__('login.forgot-your-password?')}}</a>
                </div>
            </div>
            ...
            <div class="form-footer text-center mt-5">
                <p class="text-muted">{{__('login.dont-have-an-account-yet?')}} <a href="#" class="text-primary">{{__('login.sing-up')}} </a>
                </p>
            </div>
        </div>
    </form>
