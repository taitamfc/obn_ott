					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="form-group input-number_lesson">
								...
								<input class="form-control" type="text" id="number_lesson" name='number_lesson'>
								<div class="input-error text-danger">@error('number_lesson') {{ $message }} @enderror</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group input-number_course">
								...
								<input class="form-control" type="text" id="number_course" name='number_course'>
								<div class="input-error text-danger">@error('number_course') {{ $message }} @enderror</div>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group input-number_student">
								<label for="number_student" class="col-form-label">Number Student</label>
								<input class="form-control" type="text" id="number_student" name='number_student'>
								<div class="input-error text-danger">@error('number_student') {{ $message }} @enderror</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group input-number_grade">
								...
								<input class="form-control" type="text" id="number_grade" name='number_grade'>
						...
						<div class="col-lg-6">
							<div class="form-group input-number_subject">
								...
								<input class="form-control" type="text" id="number_subject" name='number_subject'>
								<div class="input-error text-danger">@error('number_subject') {{ $message }} @enderror</div>
							</div>
						</div>
					</div>
				</div>
