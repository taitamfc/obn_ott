    ...
    <div class="main-content-inner" style="max-width: 100% !important;">
            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-between flex-wrap">
                    <div class="d-flex align-items-center dashboard-header flex-wrap mb-3 mb-sm-0">
                        <h5 class="mr-4 mb-0 font-weight-bold">Notices</h5>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card notice-table-results">
...
@include('adminsystems.notices.edit')
@include('adminsystems.notices.create')
@endsection

@section('footer')
<script>
var indexUrl = "{{ route('notices.index') }}";
var positionUrl = "";
var params = <?= json_encode(request()->query()); ?>;
var wrapperResults = '.notice-table-results';
        ...
        jQuery.ajax({
            ...
            success: function(res) {
                if (res.success) {
                    ...
                    formUpdate.find('.input-title input').val(formData.title);
                    formUpdate.find('.input-content textarea').val(formData.content);
                }
            }
        });
    })
