            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group input-name">
                        <label for="name" class="col-form-label">{{__('admin-themes.title')}}</label>
                        <input class="form-control" type="text" id="name" name='name'>
                        <div class="input-error text-danger">@error('name') {{ $message }} @enderror</div>
                    </div>

                    <div class="form-group input-video">
                        <label for="description" class="col-label">{{__('admin-themes.description')}}</label>
                    ...
                    <div class="form-group input-image">
                        <label for="image" class="col-form-label">{{__('admin-themes.banner')}}</label>
                        <input class="form-control" type="file" name='image' id="image">
                        <div class="input-error text-danger">@error('image') {{ $message }} @enderror</div>
                    </div>

                    <div class="form-group input-video">
                        <label for="video" class="col-form-label">{{__('admin-themes.media-file')}}</label>
                    ...
                    <div class="form-group input-link">
                        <label for="link" class="col-form-label">{{__('admin-themes.link')}}</label>
                        <input class="form-control" type="text" id="link" name='link'>
                        <div class="input-error text-danger">@error('link') {{ $message }} @enderror</div>
                    </div>

                    <div class="form-group">
                        <label for="status" class="col-form-label">{{__('admin-themes.status')}}</label>
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary add-item" type='button'
                        data-action="{{ route('admin.banners.store') }}">{{__('sys.save-changes')}}</button>
