<div class="modal fade" id="modalCreateUser" style="display: none;" aria-hidden="true">
    <form id="formCreateUser" action="{{ route('admin.users.store') }}" method="post" enctype="multipart/form-data">
