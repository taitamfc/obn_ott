<div class="modal fade" id="modalCreate" style="display: none;" aria-hidden="true">
    <form id="formCreate" action="{{ route('admin.sites.store') }}" method="post" enctype="multipart/form-data">
        <div class="modal-dialog modal-dialog-centered" role="document">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{__('admin-setting.create-new')}}</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group input-name">
                        ...
                        <div class="input-error text-danger">@error('slug') {{ $message }} @enderror</div>
                    </div>
