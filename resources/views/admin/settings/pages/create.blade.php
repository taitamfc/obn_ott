            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-between flex-wrap">
                    <div class="d-flex align-items-center dashboard-header flex-wrap mb-3 mb-sm-0">
                        <h5 class="mr-4 mb-0 font-weight-bold">{{__('admin-setting.create-page')}}</h5>
                    </div>
                ...
                <form id="formCreate" action="{{ route('admin.pages.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <button type="button" class='btn btn-primary add-item float-right'>{{__('admin-setting.save')}}</button>
                        </div>
                    </div>
                </form>
            </div>
