...
<div class="col-12 col-md-12 mt-2">
    <div class="card">
      ...
      <h3>Danh Sách Sản Phẩm</h3>   
        ...
        <div class="card-body">
            <div class="col-12">
                <a class="btn btn-success mb-2" href="index.php?controller=product&action=create">Thêm mới</a>
        ...
        ?>
                        <tr>
                            ...
                            <td>
                                <a href="index.php?controller=product&action=destroy&id=<?php echo $r['id'];?>"
