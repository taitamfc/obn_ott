    ...
    <div class="card">
        ...
        <div class="col-12 col-md-12 mt-2">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-12">
                        <a class="btn btn-success mb-2" href="index.php?controller=customer&action=create">Thêm mới</a>
        ...
        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="index.php?controller=customer&action=destroy&id=<?php echo $r['id'];?>"
