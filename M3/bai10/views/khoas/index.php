...
<div class="col-12 col-md-12 mt-2">
    <div class="card">
        ...
        <div class="card-body">
            <div class="col-12">
                <a class="btn btn-success mb-2" href="index.php?controller=khoa&action=create">Thêm mới</a>
...
<?php
    ...
    <tr>
        ...
        <td>
        <a href="index.php?controller=khoa&action=destroy&id=<?php echo $r['id'];?>"
                               class="btn btn-danger btn-sm" onclick="return confirm('Bạn chắc chắn muốn xoá?')">Xóa</a>
                            <a href="index.php?controller=khoa&action=show&id=<?php echo $r['id'];?>" class="btn btn-info btn-sm">Xem</a> 
                            <a href="index.php?controller=khoa&action=edit&id=<?php echo $r['id'];?>"
