...
class PaymentController extends MainController
{
    ...
    public function handlePayment(Request $request)
    {
        ...
        $response = $provider->createOrder([
            "intent" => "CAPTURE",
            "application_context" => [
                "return_url" => route('website.success.payment',['site_name'=> $this->site_name]),
        ...
        if (isset($response['id']) && $response['id'] != null) {
            ...
            try {
                ...
                $bill->course_id =isset($request->course)?$request->course:'';
                $bill->subscription_id = isset($request->subscription)?$request->subscription:'';
